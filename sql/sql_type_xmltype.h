...
class Type_handler_xmltype: public Type_handler_varchar
{
public:
...
extern Named_type_handler<Type_handler_xmltype> type_handler_xmltype;
...
class Field_xmltype:public Field_varstring
{
